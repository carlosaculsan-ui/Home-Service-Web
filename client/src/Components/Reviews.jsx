const REVIEWS = [
  {
    ...
    location: "Manila, PH",
    rating: 5,
    comment: "hanap.ph is amazing! The cleaning crew arrived on time and did an incredible job. My house has never looked this clean. Highly recommended!",
    service: "Cleaning",
    avatar: "DF",
  },
  {
  ...
  },
  {
    ...
    location: "Makati, PH",
    rating: 5,
    comment: "The electrician was very knowledgeable and explained everything clearly. Fair pricing and excellent work. hanap.ph is now my go-to for home services!",
    service: "Electrical",
    avatar: "MV",
  },
  {
